...
Após a aplicação das medidas de mitigação, realizou-se um segundo ciclo de testes. A tabela abaixo resume o estado atual das vulnerabilidades:
...
Mixed Content & Mitigada  &
Todos os recursos são forçados via HTTPS; consola do browser sem avisos de segurança mista. \\ \hline
