...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{} >{\bfseries}p{4cm} p{3.5cm} >{\RaggedRight\arraybackslash}X @{}}
        ...
        Ficheiros \texttt{.map} deixaram de ser carregados pelo navegador. \\ 
        \addlinespace
        ...
        Tentativas de redirecionamento para \texttt{https://malicious.com} resultam no retorno seguro à Homepage. \\ 
        \addlinespace
